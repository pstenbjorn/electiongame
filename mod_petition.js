...
(function () {
  ...
  const cases = [
    { id: "CQ-30", name: "Robin A. Castellano", office: "Board of Supervisors, Dist. 2",
      eligible: true, onTime: true, requiredSigs: 125, submittedSigs: 168, validSigs: 149,
      facialDefect: null, cureOpen: true,
      note: "Clean filing: timely, fee paid, eligibility met, petition comfortably over the 125-signature threshold." },
    { id: "CQ-31", name: "Desmond P. Whitaker", office: "City Council, At-Large",
      eligible: true, onTime: true, requiredSigs: 125, submittedSigs: 205, validSigs: 116,
      facialDefect: null, cureOpen: true,
    ...
    { id: "CQ-32", name: "Aisha N. Bello", office: "School Board, Seat 4",
      eligible: true, onTime: true, requiredSigs: 125, submittedSigs: 185, validSigs: 153,
    ...
    { id: "CQ-33", name: "Lars E. Henningsen", office: "Board of Supervisors, Dist. 5",
      eligible: true, onTime: true, requiredSigs: 125, submittedSigs: 176, validSigs: 151,
    ...
    { id: "CQ-34", name: "Priscilla O. Vance", office: "Mayor",
      eligible: false, onTime: true, requiredSigs: 125, submittedSigs: 363, validSigs: 307,
      facialDefect: null, cureOpen: true, ineligibleReason: "Does not meet the residency requirement for the office.",
      note: "Petition and paperwork are flawless — but the candidate does not meet an eligibility requirement." },
    { id: "CQ-35", name: "Marcus T. Delgado", office: "Senate of Virginia, Dist. 31",
      eligible: true, onTime: false, requiredSigs: 250, submittedSigs: 430, validSigs: 372,
      facialDefect: null, cureOpen: true,
      note: "A strong petition (a Senate seat needs 250) — but the packet was filed after the candidate filing deadline closed." },
    { id: "CQ-36", name: "Yelena R. Sokolova", office: "School Board, Seat 1",
      eligible: true, onTime: true, requiredSigs: 125, submittedSigs: 173, validSigs: 147,
      facialDefect: "notary_missing", cureOpen: false,
      note: "Valid petition, but the required witness/notarization is missing and the cure window has now closed." },
    { id: "CQ-37", name: "Theo B. Nakamura", office: "Board of Supervisors, Dist. 2",
      eligible: true, onTime: true, requiredSigs: 125, submittedSigs: 134, validSigs: 127,
      facialDefect: null, cureOpen: true,
      note: "Razor-thin margin: valid signatures clear the 125 requirement by 2. Count carefully — it still clears." },
    { id: "CQ-38", name: "Gwendolyn S. Ackerman", office: "Mayor",
      eligible: false, onTime: true, requiredSigs: 125, submittedSigs: 325, validSigs: 276,
    ...
    { id: "CQ-39", name: "Hassan I. Farouk", office: "City Council, At-Large",
      eligible: true, onTime: true, requiredSigs: 125, submittedSigs: 158, validSigs: 137,
      facialDefect: "missing_fee", cureOpen: true,
  ...
  const cfg = {
    ...
    primer: {
      what: "Validates nominating petitions and candidate filings to decide who appears on the ballot — confirming eligibility, validating signatures, and checking the filing deadline and fee.",
      matters: "Ballot access cuts both ways: keep a qualified candidate off and you disenfranchise their supporters; let an ineligible one on and you risk voiding the contest. Every candidate gets the same scrutiny.",
      terms: [
        ["Valid signature", "A signature that survives review — a registered voter, in-district, not a duplicate. Raw submitted counts don't qualify."],
        ["Facial defect", "A curable paperwork problem (missing fee, unsigned declaration, missing witness)."],
        ["Cure window", "The period to fix a facial defect. Eligibility and filing deadlines are NOT curable."],
      ],
    },
    question: "Place this candidate on the ballot, issue a cure notice, or disqualify?",
    stakes: "Wrongly disqualifying denies ballot access; wrongly qualifying puts an ineligible candidate before voters.",
